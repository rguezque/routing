 ...
 * 
 * @function PDO pdo_connection(string $dsn, string $username, string $password, array $options = []) Devuelve una conexión PDO
 */
...
function pdo_connection(string $dsn, string $username, string $password, array $options = []): PDO {
    $options = !empty($options) ? $options : [PDO::ATTR_PERSISTENT => true];
